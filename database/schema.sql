...
-- 4. USERS TABLE (ตารางบุคลากรที่มีสิทธิ์เข้าถึง)
CREATE TABLE users (
...
INSERT INTO users (email, full_name, phone, role_id) VALUES
('supot.meskp@gmail.com', 'สุพจน์ เหมสถล (กรรมการผู้จัดการ)', '02-116-4125', 'managing_director'),
('admin@skpassociation.co.th', 'ผู้จัดการฝ่ายธุรการและประสานงาน', '02-116-4125', 'admin_coordinator_manager'),
('engineer@skpassociation.co.th', 'วิศวกรโครงการ', '02-116-4125', 'project_engineer');
